...
javac -encoding UTF-8 -d target\classes -cp "lib\*;target\classes" services\CourseService.java services\AttendanceService.java services\CameraService.java services\QRScannerService.java services\ExcelExportService.java services\BackupService.java
if errorlevel 1 (
